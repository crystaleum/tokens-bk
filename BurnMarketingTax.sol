...
abstract contract ERC20 is Context, IERC20, Auth {
    ...
    constructor(string memory token_name, string memory token_symbol, uint8 dec, address payable _minter, address payable _marketer, uint256 _supply, uint256 _burnBP, uint256 _marketingBP, uint256 _shardLiq) Auth(payable(msg.sender)) {
...
contract BurnMarketingTax is ERC20 {
    
    constructor () ERC20 ("name", "symbol", 18, payable(msg.sender),payable(0xd166dF9DFB917C3B960673e2F420F928d45C9be1),1000000,500,500,1000) {
