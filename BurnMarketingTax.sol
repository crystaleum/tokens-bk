...
abstract contract ERC20 is Context, IERC20, Auth {
    ...
    constructor(string memory token_name, string memory token_symbol, uint8 dec, address payable _minter, address payable _marketer, uint256 _supply, uint256 _burnBP, uint256 _marketingBP) Auth(payable(msg.sender)) {
